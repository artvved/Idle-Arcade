...
namespace Game.System
{
    public class CustomerTargetSystem : IEcsInitSystem, IEcsRunSystem
    {
        ...
        readonly EcsPoolInject<CashTableTag> cashPool = default;
        ...
        public void Init(IEcsSystems systems)
        {
            ...
            queueCashFilter = world.Filter<QueueComponent>().Inc<CashTableTag>().End();
        }
        ...
        private bool TryGetFirst(ref int res, List<EcsPackedEntity> queue)
        {
            ...
            queue[0].Unpack(world, out int first);
            res = first;
            return true;
        }
